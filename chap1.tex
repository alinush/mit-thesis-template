...
instruction sets \cite{article-minimal,article-full}.  By getting rid of more
...
\cite{article-crossref,whole-journal,inbook-minimal}.  In these cases, the
compiler not only is responsible for faithfully generating native code to
match the source language, but also must be aware of instruction latencies,
delayed branches, pipeline stages, and a multitude of other factors in order
to generate fast code \cite{inbook-full}.
...
\cite{book-minimal} The CDC 6600 had all of its instructions performing
...
flow control at the same time the floating point units are active. \cite{booklet-minimal}}
...
\cite{article-crossref,incollection-minimal}  In trace scheduling, code can be
...
seendescribed by Gibbons. \cite{inbook-full}
